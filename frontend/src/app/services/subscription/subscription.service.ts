...
import { subscription, type Subscription } from '../../schemas/subscription.schema';
import { map, Observable } from 'rxjs';
import type { User } from '../../schemas/user.schema';
import type { SubscriptionPatch } from '../../types/subscription-patch';
...
export class SubscriptionService {
  ...
  public patchSubscription(guildId: GuildId, subscriptionId: number, data: SubscriptionPatch) {
